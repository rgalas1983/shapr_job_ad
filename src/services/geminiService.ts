...
1.  **Main Sections:** MUST use **Markdown Header 2 (##)** for: "Why this role?", "What you’ll do", "What you’ll bring", "A sneak peek into our stack...", "Why you’ll love working here", and "About Shapr3D".
2.  **"Why this role?" & "Benefits":** MUST use **Bold Bullet Points** (e.g., \`* **Shape the future:** Description\`).
3.  **"What you'll do" & "What you'll bring":** MUST use **Standard Clean Bullet Points** (e.g., \`* Collaborate with the design team...\`). Do NOT use bold headers at the start of these bullets.
4.  **Layout:** Ensure there is an empty line before every single Main Section Header (##) to ensure correct paragraph spacing.
...
## What you’ll do
* [Action-oriented bullet point 1 (Standard text, NO bold header)]
* [Action-oriented bullet point 2 (Standard text, NO bold header)]
* [Action-oriented bullet point 3 (Standard text, NO bold header)]
* [Action-oriented bullet point 4 (Standard text, NO bold header)]


## What you’ll bring
* [Skill/Experience bullet point 1 (Standard text, NO bold header)]
* [Skill/Experience bullet point 2 (Standard text, NO bold header)]
* [Skill/Experience bullet point 3 (Standard text, NO bold header)]
* [Skill/Experience bullet point 4 (Standard text, NO bold header)]
...
[Insert the correct Benefits Block from the RULES section above. Combine Global Baseline + Location Specifics. Use Bold Headers for these bullets.]
